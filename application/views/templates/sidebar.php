    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center">
                ...
                <div class="sidebar-brand-text mx-3">Approval</div>
            </a>
            ...
            <li class="nav-item <?php echo isMenuItemActive('index', $currentPage); ?>">
                <a class="nav-link" href="<?php echo base_url('approval/dashboard/index') ?>">
            ...
            <li class="nav-item <?php echo isMenuItemActive('pemesanan', $currentPage); ?>">
                <a class="nav-link" href="<?php echo base_url('approval/dashboard/pemesanan') ?>">
